...
void main(){
  group('Mock Authentication', () {
    ...
    test('Should be abe to initialized in less than 2 sec', () async {
      await provider.initialize();
      expect(provider.isInitialized, true);
    ...
    test('Logged in user should be able to get verified',(){
      ...
      expect(user!.isEmailVerified, true); //user! force.
    });
...
class MockAuthProvider implements AuthProvider{
  ...
  Future<AuthUser> logIn({
    ...
    const user = AuthUser(isEmailVerified: false, email: 'lala@gmail.com');
    _user =user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'lalal@gmail.com');
    _user= newUser;
  }
